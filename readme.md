...
| Keyword          | Type  | Default           | Description |                                                                                                                                                                                                                                                                   |
|------------------|-------|-------------------|-------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| :node-type       | :mstp | :master or :slave |     :master | Only Master nodes can initiate requests and pass tokens. Slave nodes can only respond to requests, and are not part of the token-passing ring. See http://store.chipkin.com/articles/how-does-bacnet-mstp-discover-new-devices-on-a-network for more information. |
