...
| :baud-rate                      | :mstp        | number                 | 115200               |                                                                                                                                                                                                                                                                                                                                                                                          |
| :databits                       | :mstp        | serial.core/DATABITS_* | DATABITS_8           |                                                                                                                                                                                                                                                                                                                                                                                          |
| :stopbits                       | :mstp        | serial.core/STOPBITS_* | STOPBITS_1           |                                                                                                                                                                                                                                                                                                                                                                                          |
| :parity                         | :mstp        | serial.core/PARITY_*   | PARITY_NONE          |                                                                                                                                                                                                                                                                                                                                                                                          |
| :mstp-config                    | :mstp        | map                    | nil                  | Additional MSTP configuration. The below keys are included:                                                                                                                                                                                                                                                                                                                              |
| [:mstp-config :node-type]       | :mstp        | :master or :slave      | :master              | Only Master nodes can initiate requests and pass tokens. Slave nodes can only respond to requests, and are not part of the token-passing ring. See http://store.chipkin.com/articles/how-does-bacnet-mstp-discover-new-devices-on-a-network for more information.                                                                                                                        |
